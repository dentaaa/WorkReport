            ...
            <div class="ms-auto">
                <ul class="list-unstyled">
                    ...
                    <li class="dropdown pc-h-item">
                        ...
                        <a class="pc-head-link dropdown-toggle arrow-none position-relative" data-bs-toggle="dropdown"
                            ...
                            @if ($unreadNotificationCount > 0)
                                <span class="badge bg-danger rounded-pill position-absolute"
                                    style="top:4px; right:0; font-size:10px;">
                        ...
                        <div class="dropdown-menu dropdown-notification dropdown-menu-end pc-h-dropdown">
                            ...
                            <div class="header-notification-scroll" style="max-height:400px; overflow:auto;">
                                        ...
                                        <a href="{{ route('notifications.open', $notification) }}"
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-shrink-0">
                                                    ...
                                                    <i class="{{ $notification->icon }} fs-4 {{ $iconColor }}"></i>
